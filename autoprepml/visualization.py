...
def plot_outliers(df: pd.DataFrame, outlier_indices: list = None, figsize: tuple = (12, 6)) -> str:
    ...
    if len(numeric_cols) == 0:
        fig, ax = plt.subplots(figsize=figsize)
        ax.text(0.5, 0.5, "No numeric columns found", ha="center", va="center", fontsize=14)
        ax.axis("off")
    else:
