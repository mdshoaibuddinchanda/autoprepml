...
def datetime_df():
    ...
    data = {"date": dates, "value": np.random.randn(100)}
...
class TestPolynomialFeatures:
    ...
    def test_create_polynomial_features_basic(self, sample_df):
        ...
        result = fe.create_polynomial_features(columns=["age", "income"], degree=2)
    ...
    def test_create_polynomial_features_degree(self, sample_df):
        ...
        result_deg2 = fe2.create_polynomial_features(columns=["age", "income"], degree=2)

        fe3 = AutoFeatureEngine(sample_df.copy())
        result_deg3 = fe3.create_polynomial_features(columns=["age", "income"], degree=3)
    ...
    def test_create_polynomial_invalid_columns(self, sample_df):
        ...
        with pytest.raises((ValueError, KeyError)):
            fe.create_polynomial_features(columns=["nonexistent"], degree=2)
    ...
    def test_create_polynomial_with_categorical(self, sample_df):
        ...
        with pytest.raises((ValueError, TypeError)):
            fe.create_polynomial_features(columns=["age", "category"], degree=2)
...
class TestInteractionFeatures:
    ...
    def test_create_interactions_basic(self, sample_df):
        ...
        result = fe.create_interactions(columns=["age", "income", "credit_score"])
    ...
    def test_create_interactions_limit(self, sample_df):
        ...
        result = fe.create_interactions(
            columns=["age", "income", "credit_score"], max_interactions=2
        )
    ...
    def test_create_interactions_two_columns(self, sample_df):
        ...
        result = fe.create_interactions(columns=["age", "income"])
...
class TestRatioFeatures:
    ...
    def test_create_ratio_features_limit(self, sample_df):
        ...
        result = fe.create_ratio_features(columns=["age", "income", "credit_score"], max_ratios=2)
...
class TestBinnedFeatures:
    ...
    def test_create_binned_features_basic(self, sample_df):
        ...
        result = fe.create_binned_features(columns=["age", "income"], n_bins=5)
    ...
    def test_create_binned_features_strategies(self, sample_df):
        ...
        for strategy in strategies:
            fe = AutoFeatureEngine(sample_df.copy())
            result = fe.create_binned_features(columns=["age"], n_bins=5, strategy=strategy)
    ...
    def test_create_binned_features_bin_count(self, sample_df):
        ...
        result = fe.create_binned_features(columns=["age"], n_bins=3)
...
class TestAggregationFeatures:
    ...
    def test_create_aggregation_features_basic(self, sample_df):
        ...
        result = fe.create_aggregation_features(
            columns=["age", "income"], operations=["mean", "sum"]
        )
    ...
    def test_create_aggregation_operations(self, sample_df):
        ...
        result = fe.create_aggregation_features(columns=["age", "income"], operations=operations)
    ...
    def test_create_aggregation_single_operation(self, sample_df):
        ...
        result = fe.create_aggregation_features(columns=["age", "income"], operations=["mean"])
...
class TestDatetimeFeatures:
    ...
    def test_create_datetime_features_specific(self, datetime_df):
        ...
        result = fe.create_datetime_features(columns=["date"], features=features)
    ...
    def test_create_datetime_features_all(self, datetime_df):
        ...
        result = fe.create_datetime_features(
            columns=["date"], features=["year", "month", "day", "dayofweek", "quarter", "hour"]
        )

        self._extracted_from_test_create_datetime_features_all_12(result, "date_dayofweek")
...
class TestFeatureImportance:
    ...
    def _extracted_from_test_get_feature_importance_regression_3(
        self, sample_df, target_column, task
    ):
...
class TestAutoFeatureEngineering:
    ...
    def test_auto_feature_engineering_basic(self, sample_df):
        ...
        result, summary = auto_feature_engineering(sample_df.copy())
    ...
    def test_auto_feature_engineering_with_selection(self, sample_df):
        ...
        result, summary = auto_feature_engineering(
            sample_df.copy(), target_column="target", max_features=15
        )
...
class TestEdgeCases:
    ...
    def test_all_categorical_dataframe(self):
        ...
        df = pd.DataFrame({"cat1": ["A", "B", "C"] * 10, "cat2": ["X", "Y", "Z"] * 10})

        # The fixture should remain valid even when no numeric features exist.
        assert not df.select_dtypes(include=[np.number]).columns.tolist()

    def test_constant_column(self):
        """Test with constant column."""
        df = pd.DataFrame({"constant": [5] * 100, "varying": np.random.randn(100)})
