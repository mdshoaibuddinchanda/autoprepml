...
print("=" * 80)
print("AutoPrepML comprehensive functionality test")
print("=" * 80)
...
try:
    ...
    df_test = pd.DataFrame(
        {"a": [1, 2, np.nan, 4, 5], "b": [5, np.nan, 7, 8, 9], "c": [1, 2, 3, 4, 5]}
    )
...
try:
    ...
    nodes_df = pd.DataFrame({"id": [1, 2, 3, 4], "label": ["A", "B", "C", "D"]})
...
print("\n" + "=" * 80)
print("AutoPrepML systems operational.")
print("=" * 80)
